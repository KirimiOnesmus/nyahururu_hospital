...
researcherSchema.index({ emailVerificationToken: 1, emailVerificationExpire: 1 });
...
researcherSchema.virtual("isResearchAdmin").get(function () {
  return [RESEARCHER_ROLES.ADMIN, RESEARCHER_ROLES.SUPERADMIN].includes(this.role);
});

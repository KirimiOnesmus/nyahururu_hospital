...
exports.createService = async (req, res) => {
  try {
    const { name, division, category, description, headOfDepartment, contactInfo, serviceHours, location, tariffInfo, nhifCovered } = req.body;
...
exports.updateService = async (req, res) => {
  try {
    ...
    if (nhifCovered !== undefined) service.nhifCovered = nhifCovered === 'true' || nhifCovered === true || false;

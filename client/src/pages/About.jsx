...
//             } md:translate-x-0 w-64 md:w-72 overflow-y-auto`}
//           >
//             <div className="p-6 md:pt-8 space-y-2">
//               <h3 className="text-lg font-bold text-gray-800 mb-4 px-3">Navigation</h3>
//               {menuItems.map((item) => {
//                 const Icon = item.icon;
//                 return (
...
//           {/* Main Content */}
//           <main className="flex-1 px-6 md:px-12 py-8 space-y-16 max-w-5xl">
...
//                 <div className="space-y-4 text-gray-700 leading-relaxed">
//                   <p className="text-lg">
//                     Nairobi County Referral Hospital has been a cornerstone of healthcare excellence 
//                     in our community for over [X] years. Founded in [Year], our institution has grown 
//                     from a small clinic to a comprehensive medical facility serving thousands of 
//                     patients annually.
//                   </p>

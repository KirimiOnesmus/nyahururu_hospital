...
const Downloads = () => {
  ...
  const fetchReports = async () => {
    try {
      ...
      const uniqueCategories = [...new Set(reportsData.map(r => r.category).filter(Boolean))];
  ...
  const getFileIcon = (filename) => {
    ...
    if (["doc", "docx"].includes(ext)) return <FaFileWord className="text-blue-500 text-3xl" />;
    if (["xls", "xlsx"].includes(ext)) return <FaFileExcel className="text-green-500 text-3xl" />;
    if (["jpg", "jpeg", "png", "gif"].includes(ext)) return <FaFileImage className="text-purple-500 text-3xl" />;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-4 border-l-4 border-blue-500 pl-3">Downloads Center</h1>

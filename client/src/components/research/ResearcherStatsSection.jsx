...
const ProgressRing = ({ pct, color, icon: Icon, label }) => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
      ...
      <p
        style={{ fontSize: 12, fontWeight: 600, color: "#64748B", margin: 0, textAlign: "center" }}
      >
        {label}
      </p>
    </div>
        ...
        >
          ...
          >
            ...
            <Bar
              label="Views"
              value={stats.views}
              max={Math.max(stats.views, stats.downloads, 1)}
              color="#0D9488"
            />
            <Bar
              label="Downloads"
          ...
          >
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <div
                style={{ height: 8, background: "#E2E8F0", borderRadius: 99, overflow: "hidden" }}
              >
                <div
                  style={{
                    height: "100%",

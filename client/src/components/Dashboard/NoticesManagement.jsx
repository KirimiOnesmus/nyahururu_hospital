...
const NoticesManagement = () => {
    ...
    const mockNotices = [
      {
        ...
        audience: "All",
        content: "The hospital will undergo routine maintenance on...",
      ...
      },
      {
        ...
        category: "Policy",
        audience: "Patients",
        content: "Effective immediately, visiting hours are...",
      ...
      },
      {
        ...
        category: "Emergency",
        audience: "Staff",
        content: "All staff members are required to participate...",
      ...
      },
      {
        ...
        category: "Event",
        audience: "Public",
        content: "Free health screening available...",
  ...
  const handleBulkAction = (action) => {
    console.log(`Bulk action: ${action}`, selectedNotices);
    setSelectedNotices([]);
  };
                    ...
                    <tr key={notice.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">By {notice.createdBy}</p>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-700">{notice.startDate}</td>
                      <td className="px-6 py-4 text-sm text-gray-700">{notice.endDate || "—"}</td>
            ...
            <div className="bg-white rounded-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Created by {selectedNotice.createdBy} on {selectedNotice.createdAt}
                  </p>
                </div>
                <button
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className={`px-3 py-1 rounded text-sm font-medium ${getCategoryColor(selectedNotice.category)}`}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{selectedNotice.endDate || "No expiry"}</p>
                  </div>
                </div>
                    ...
                    <div className="flex items-start gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 text-xs">
                          {selectedNotice.createdAt} by {selectedNotice.createdBy}
                        </p>
                      </div>
                    </div>
                  </div>
